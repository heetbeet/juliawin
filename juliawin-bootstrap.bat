...
powershell.exe -c "(new-object net.webclient).DownloadFile('https://raw.githubusercontent.com/heetbeet/juliawin/master/src/julia-win-installer.jl', '%temp%\juliawin\src\julia-win-installer.jl')"
