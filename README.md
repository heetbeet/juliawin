...
You can <a href="https://raw.githubusercontent.com/heetbeet/juliawin/master/julia-win-installer.bat">right-click, and Save Link As</a>, and run the script (Github doesn't provide a save-as popup unfortunately).
