...
You can right-click, <a href="https://raw.githubusercontent.com/heetbeet/juliawin/master/julia-win-installer.bat">Save Link As</a>, and run the installer script (Github doesn't provide a save-as popup unfortunately).
